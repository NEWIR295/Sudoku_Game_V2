...
void SudokuGame::initGame(void)
{
    ...
    if (fileManager.readJsonFile(board.getBoardData()))
    {
    ...
    while (true)
    {
        ...
        case 1:
            ...
            if(board.getCell(row - 1, col - 1) != 0){
                std::cout << "|Cell already filled. Please try again.          |" << std::endl;
                break;
            }
            if (board.setCell(row - 1, col - 1, num))
            {
        ...
        case 3:
            ...
            if (SudokuGenerator::generatePuzzle(board, difficultyLevel))
            {
        ...
        case 4:
            ...
            std::cin >> fileName;
            fileManager.changeFile(fileName);
            if (fileManager.readJsonFile(board.getBoardData()))
            {
        ...
        case 5:
            ...
            std::cin >> fileName;
            fileManager.changeFile(fileName);
            if (fileManager.writeJsonFile(board.getBoardData()))
            {
